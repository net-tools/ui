...
div.appendChild(_createLabel(name,unid,field));switch(field.type){case "select":var e=document.createElement('select');var opt=field.options||[];var optl=opt.length;for(var i=0;i<optl;i++){if(typeof opt[i]==='object')
...
if(field.autocomplete){new Awesomplete(e,{list:field.options||[],tabSelect:!0,autoFirst:!0,maxItems:15,sort:function(a,b){return(a<b)?-1:1},filter:Awesomplete.FILTER_STARTSWITH});if(typeof field.onchange=='function'){e.addEventListener('awesomplete-selectcomplete',function(o){field.onchange.call(e,e.form.elements,o.text.value,o.text.label)})}}
return div}
