...
this.params.outputTo=container;else container=this.params.outputTo;this.params.orientation=this.params.orientation||'P';this.params.tabs=this.params.tabs||[];this.params.id=this.params.id||container.id;if(this.params.orientation=='P')
